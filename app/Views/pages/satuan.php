    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Satuan</h3>
                <div class="nk-block-des text-soft">
                    <p>Manajamen referensi satuan aset</p>
                </div>
            </div>
                        ...
                        <div id="form-jenis">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" v-model="satuan">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" v-if="mode === 'create'" v-on:click="saveSatuan" class="btn btn-info">Save</button>
                                <button type="submit" v-if="mode === 'edit'" v-on:click="saveSatuan" class="btn btn-warning">Save</button>
                            </div>
                            ...
                            <div class="login-info" v-show="linfo">
                                <div v-if="ainfo == 'Berhasil menyimpan data satuan'" class="alert alert-success alert-icon">
                                    <em class="icon ni ni-check-circle"></em> <strong>{{ ainfo }}</strong>
                                </div>
                                <div v-else-if="ainfo == 'Tidak ada perubahan data satuan'" class="alert alert-warning alert-icon">
                                    <em class="icon ni ni-check-circle"></em> <strong>{{ ainfo }}</strong>
                                </div>
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist is-compact">
                                    <div class="nk-tb-item nk-tb-head">
                                        <div class="nk-tb-col"><span class="sub-text">Satuan</span></div>
                                    ...
                                    <div class="nk-tb-item" v-for="(item, index) in items">
                                        <div class="nk-tb-col">
                                            <div class="user-card">
                                                <div class="user-name">
                                                    <span class="tb-lead">{{ item.satuan }}</span>
                                                </div>
                                            </div>
                                        </div>
